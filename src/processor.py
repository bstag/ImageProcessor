...
class ImageProcessor:
    ...
    def apply_enhancements(image: Image.Image, brightness: float = 1.0, contrast: float = 1.0, sharpness: float = 1.0, saturation: float = 1.0) -> Image.Image:
        ...
        # Apply brightness and contrast sequentially using Pillow's ImageEnhance
        # This matches Pillow's reference behavior (including clipping/rounding)
        # and avoids assumptions about the mean of the brightness-adjusted image.
        if brightness != 1.0:
